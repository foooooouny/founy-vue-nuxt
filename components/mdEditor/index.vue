...
<script>
import '~/assets/mdEditor/css/font-awesome.css'
/* 引入reset文件 */
import '~/assets/mdEditor/css/reset.css'
/* 引入github的markdown样式文件 */
import '~/assets/mdEditor/css/github_markdown.css'
/* 引入atom的代码高亮样式文件 */
import '~/assets/mdEditor/css/atom_one_dark.css'
